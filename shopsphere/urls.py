...
urlpatterns = [
    ...
    path("api/v1/product/<int:pk>/", views.ProductDetailView.as_view()),
    path("api/v1/products/<int:pk>/addtocart/", views.AddToCart.as_view()),
    path("api/v1/carts/", views.CartListView.as_view()),
    path("api/v1/carts/<int:pk>/", views.UpdateCartView.as_view()),
    path("api/v1/order/", views.CheckoutView.as_view()),
    path("api/v1/order/summary/", views.OrderSummary.as_view()),
    path("api/v1/order/summary/", views.OrderSummary.as_view()),
